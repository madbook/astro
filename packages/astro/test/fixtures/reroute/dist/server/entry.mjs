...
import { e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, m as manifest$1 } from './chunks/_@astrojs-manifest_C0_q0f98.mjs';
...
const _page1 = () => import('./pages/auth/base.astro.mjs');
const _page2 = () => import('./pages/auth/dashboard.astro.mjs');
const _page3 = () => import('./pages/auth/params.astro.mjs');
const _page4 = () => import('./pages/auth/settings.astro.mjs');
const _page5 = () => import('./pages/blog/hello.astro.mjs');
const _page6 = () => import('./pages/blog/salut.astro.mjs');
const _page7 = () => import('./pages/dynamic/_id_.astro.mjs');
const _page8 = () => import('./pages/post/post-a.astro.mjs');
const _page9 = () => import('./pages/post/post-b.astro.mjs');
const _page10 = () => import('./pages/reroute.astro.mjs');
const _page11 = () => import('./pages/spread/_---id_.astro.mjs');
const _page12 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["../../../dist/assets/endpoint/generic.js", _page0],
    ["src/pages/auth/base.astro", _page1],
    ["src/pages/auth/dashboard.astro", _page2],
    ["src/pages/auth/params.astro", _page3],
    ["src/pages/auth/settings.astro", _page4],
    ["src/pages/blog/hello/index.astro", _page5],
    ["src/pages/blog/salut/index.astro", _page6],
    ["src/pages/dynamic/[id].astro", _page7],
    ["src/pages/post/post-a.astro", _page8],
    ["src/pages/post/post-b.astro", _page9],
    ["src/pages/reroute.astro", _page10],
    ["src/pages/spread/[...id].astro", _page11],
