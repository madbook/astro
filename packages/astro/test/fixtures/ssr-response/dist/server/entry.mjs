...
const _page1 = () => import('./pages/some-header.astro.mjs');
const _page2 = () => import('./pages/status-code.astro.mjs');

const pageMap = new Map([
    ["../../../dist/assets/endpoint/generic.js", _page0],
    ["src/pages/some-header.astro", _page1],
    ["src/pages/status-code.astro", _page2]
]);
