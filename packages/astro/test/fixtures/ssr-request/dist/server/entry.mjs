...
const _page1 = () => import('./pages/request.astro.mjs');

const pageMap = new Map([
    ["../../../dist/assets/endpoint/generic.js", _page0],
    ["src/pages/request.astro", _page1]
]);
