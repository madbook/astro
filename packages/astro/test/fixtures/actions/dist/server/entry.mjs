...
import { e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, m as manifest$1 } from './chunks/_@astrojs-manifest_CWCyRV8I.mjs';
import { A as AstroError, q as i18nNoLocaleFoundInPath, s as appendForwardSlash, t as joinPaths, u as MiddlewareNoDataOrNextCalled, v as MiddlewareNotAResponse, G as GetStaticPathsRequired, w as InvalidGetStaticPathsReturn, x as InvalidGetStaticPathsEntry, y as GetStaticPathsExpectedParams, z as GetStaticPathsInvalidRouteParam, B as trimSlashes, P as PageNumberParamNotFound, C as NoMatchingStaticPathFound, H as PrerenderDynamicEndpointPathCollide, J as ReservedSlotName, L as LocalsNotAnObject, K as PrerenderClientAddressNotAvailable, Q as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, T as RewriteWithBodyUsed, U as AstroResponseHeadersReassigned, R as ResponseSentError, V as fileExtension, W as slash, X as prependForwardSlash, Y as removeTrailingForwardSlash } from './chunks/astro/assets-service_6aOxa5YE.mjs';
import { R as ROUTE_TYPE_HEADER, d as REROUTE_DIRECTIVE_HEADER, e as createSlotValueFromString, r as renderTemplate, f as renderComponent, D as DEFAULT_404_COMPONENT, g as renderSlotToString, h as renderJSX, i as chunkToString, j as isRenderInstruction, k as clientLocalsSymbol, l as clientAddressSymbol, A as ASTRO_VERSION, n as responseSentSymbol, o as renderPage, p as REWRITE_DIRECTIVE_HEADER_KEY, q as REWRITE_DIRECTIVE_HEADER_VALUE, t as renderEndpoint, u as REROUTABLE_STATUS_CODES } from './chunks/astro/server_BmWOtwPc.mjs';
import 'cookie';
import { A as AstroCookies, s as sequence, d as defineMiddleware, o as onRequest } from './chunks/_astro-internal_middleware_yd5WbQC8.mjs';
import { bold, red, yellow, dim, blue } from 'kleur/colors';
import { g as getActionQueryString, d as deserializeActionResult } from './chunks/shared_C5IXs-66.mjs';
import 'clsx';
import fs from 'fs';
...
const _page2 = () => import('./pages/rewrite.astro.mjs');
const _page3 = () => import('./pages/subscribe.astro.mjs');
const _page4 = () => import('./pages/user.astro.mjs');
const _page5 = () => import('./pages/user-or-throw.astro.mjs');

const pageMap = new Map([
    ["../../../dist/actions/runtime/route.js", _page0],
    ["../../../dist/assets/endpoint/generic.js", _page1],
    ["src/pages/rewrite.astro", _page2],
    ["src/pages/subscribe.astro", _page3],
    ["src/pages/user.astro", _page4],
    ["src/pages/user-or-throw.astro", _page5]
]);
