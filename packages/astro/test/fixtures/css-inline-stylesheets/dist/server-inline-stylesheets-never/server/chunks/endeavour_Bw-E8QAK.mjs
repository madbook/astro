const id = "endeavour.md";
						const collection = "en";
						const slug = "endeavour";
						...
						const data = {title:"Endeavour",description:"Learn about the Endeavour NASA space shuttle.",publishedDate:"Sun Jul 11 2021 00:00:00 GMT-0400 (Eastern Daylight Time)",layout:"../../layouts/Layout.astro",tags:["space","90s"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/matt/src/astro/packages/astro/test/fixtures/css-inline-stylesheets/src/content/en/endeavour.md",
							rawData: undefined,
						};
