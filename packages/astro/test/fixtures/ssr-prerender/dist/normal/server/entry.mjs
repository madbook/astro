...
const _page1 = () => import('./pages/not-prerendered.astro.mjs');
const _page2 = () => import('./pages/static.astro.mjs');
const _page3 = () => import('./pages/users/_id_.astro.mjs');
const _page4 = () => import('./pages/_---params_.astro.mjs');

const pageMap = new Map([
    ["../../../dist/assets/endpoint/generic.js", _page0],
    ["src/pages/not-prerendered.astro", _page1],
    ["src/pages/static.astro", _page2],
    ["src/pages/users/[id].astro", _page3],
    ["src/pages/[...params].astro", _page4]
]);
