...
import { g as getActionQueryString, d as deserializeActionResult, e as ensure404Route, a as default404Instance, D as DEFAULT_404_ROUTE, m as manifest$1 } from './chunks/_@astrojs-manifest_DBcWpB23.mjs';
import { r as requestHasLocale, d as requestIs404Or500, n as notFound, e as redirectToFallback, f as normalizeTheLocale, h as redirectToDefaultLocale, i as computeCurrentLocale, j as computePreferredLocale, k as computePreferredLocaleList, s as shouldAppendForwardSlash } from './chunks/utils_DfpPSHlF.mjs';
import { R as ROUTE_TYPE_HEADER, e as createSlotValueFromString, r as renderTemplate, f as renderComponent, D as DEFAULT_404_COMPONENT, g as renderSlotToString, h as renderJSX, i as chunkToString, j as isRenderInstruction, k as clientLocalsSymbol, l as clientAddressSymbol, A as ASTRO_VERSION, n as responseSentSymbol$1, o as renderPage, p as REROUTE_DIRECTIVE_HEADER, q as REWRITE_DIRECTIVE_HEADER_KEY, t as REWRITE_DIRECTIVE_HEADER_VALUE, u as renderEndpoint, v as REROUTABLE_STATUS_CODES } from './chunks/astro/server_ClcBF270.mjs';
import { serialize, parse } from 'cookie';
import { A as AstroError, R as ResponseSentError, q as MiddlewareNoDataOrNextCalled, s as MiddlewareNotAResponse, G as GetStaticPathsRequired, t as InvalidGetStaticPathsReturn, u as InvalidGetStaticPathsEntry, v as GetStaticPathsExpectedParams, w as GetStaticPathsInvalidRouteParam, x as trimSlashes, P as PageNumberParamNotFound, y as NoMatchingStaticPathFound, z as PrerenderDynamicEndpointPathCollide, B as ReservedSlotName, L as LocalsNotAnObject, C as PrerenderClientAddressNotAvailable, H as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, J as RewriteWithBodyUsed, K as AstroResponseHeadersReassigned, Q as fileExtension, T as joinPaths, U as slash, V as prependForwardSlash, W as appendForwardSlash, X as removeTrailingForwardSlash } from './chunks/astro/assets-service_BBWtdYCv.mjs';
...
const _page1 = () => import('./pages/blog/_---lang_.astro.mjs');
const _page2 = () => import('./pages/current-locale.astro.mjs');
const _page3 = () => import('./pages/dynamic/_id_.astro.mjs');
const _page4 = () => import('./pages/en/blog/_id_.astro.mjs');
const _page5 = () => import('./pages/en/start.astro.mjs');
const _page6 = () => import('./pages/endurance.astro.mjs');
const _page7 = () => import('./pages/preferred-locale.astro.mjs');
const _page8 = () => import('./pages/pt/blog/_id_.astro.mjs');
const _page9 = () => import('./pages/pt/start.astro.mjs');
const _page10 = () => import('./pages/spanish.astro.mjs');
const _page11 = () => import('./pages/virtual-module.astro.mjs');
const _page12 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["../../../dist/assets/endpoint/generic.js", _page0],
    ["src/pages/blog/[...lang]/index.astro", _page1],
    ["src/pages/current-locale.astro", _page2],
    ["src/pages/dynamic/[id].astro", _page3],
    ["src/pages/en/blog/[id].astro", _page4],
    ["src/pages/en/start.astro", _page5],
    ["src/pages/endurance.astro", _page6],
    ["src/pages/preferred-locale.astro", _page7],
    ["src/pages/pt/blog/[id].astro", _page8],
    ["src/pages/pt/start.astro", _page9],
    ["src/pages/spanish/index.astro", _page10],
    ["src/pages/virtual-module.astro", _page11],
...
export { createApp, manifest, pageMap };
