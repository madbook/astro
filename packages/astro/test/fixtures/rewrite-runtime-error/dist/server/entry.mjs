...
const _page1 = () => import('./pages/errors/from.astro.mjs');
const _page2 = () => import('./pages/errors/to.astro.mjs');

const pageMap = new Map([
    ["../../../dist/assets/endpoint/generic.js", _page0],
    ["src/pages/errors/from.astro", _page1],
    ["src/pages/errors/to.astro", _page2]
]);
