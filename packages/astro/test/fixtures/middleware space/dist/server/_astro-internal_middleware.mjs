import { s as sequence, d as defineMiddleware } from './chunks/index_DgQODzmk.mjs';
import './chunks/shared_BApMds8w.mjs';
import 'cookie';
...
const onRequest$3 = sequence(first, second, third);
