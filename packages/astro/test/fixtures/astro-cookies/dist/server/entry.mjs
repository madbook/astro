...
import { g as getActionQueryString, d as deserializeActionResult, e as ensure404Route, a as default404Instance, D as DEFAULT_404_ROUTE, m as manifest$1 } from './chunks/_@astrojs-manifest_CKyONryT.mjs';
...
const _page1 = () => import('./pages/early-return.astro.mjs');
const _page2 = () => import('./pages/from.astro.mjs');
const _page3 = () => import('./pages/from-endpoint.astro.mjs');
const _page4 = () => import('./pages/get-json.astro.mjs');
const _page5 = () => import('./pages/rewrite-target.astro.mjs');
const _page6 = () => import('./pages/set-prefs.astro.mjs');
const _page7 = () => import('./pages/set-value.astro.mjs');
const _page8 = () => import('./pages/to-endpoint.astro.mjs');

const pageMap = new Map([
    ["../../../dist/assets/endpoint/generic.js", _page0],
    ["src/pages/early-return.astro", _page1],
    ["src/pages/from.astro", _page2],
    ["src/pages/from-endpoint.ts", _page3],
    ["src/pages/get-json.astro", _page4],
    ["src/pages/rewrite-target.astro", _page5],
    ["src/pages/set-prefs.js", _page6],
    ["src/pages/set-value.astro", _page7],
    ["src/pages/to-endpoint.ts", _page8]
]);
