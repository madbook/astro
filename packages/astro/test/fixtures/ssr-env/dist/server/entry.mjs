...
function generatePaginateFunction(routeMatch) {
  return function paginateUtility(data, args = {}) {
    ...
    const result = [...Array(lastPage).keys()].map(num => {
      ...
      const first = pageNum === 1 ? void 0 : correctIndexRoute(routeMatch.generate({
        ...params,
        page: includesFirstPageNumber ? "1" : void 0
      }));
      const last = pageNum === lastPage ? void 0 : correctIndexRoute(routeMatch.generate({
        ...params,
...
class RenderContext {
  ...
  static create({
    ...
    return new RenderContext(pipeline, locals, sequence(...pipeline.internalMiddleware, middleware ?? pipeline.middleware), pathname, request, routeData, status, void 0, void 0, void 0, props);
  }
  /**
  ...
  async #executeRewrite(reroutePayload) {
    ...
    const [routeData, component, newURL] = await this.pipeline.tryRewrite(reroutePayload, this.request, this.originalRoute);
    this.routeData = routeData;
...
class AppPipeline extends Pipeline {
  ...
  static create(manifestData, {
    ...
    const pipeline = new AppPipeline(logger, manifest, mode, renderers, resolve, serverLike, streaming, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, false, defaultRoutes);
...
const _page1 = () => import('./pages/ssr.astro.mjs');

const pageMap = new Map([
    ["../../../dist/assets/endpoint/generic.js", _page0],
    ["src/pages/ssr.astro", _page1]
]);
