...
const typeHandlers = /* @__PURE__ */new Map([["bmp", BMP], ["cur", CUR], ["dds", DDS], ["gif", GIF], ["heif", HEIF], ["icns", ICNS], ["ico", ICO], ["j2c", J2C], ["jp2", JP2], ["jpg", JPG], ["ktx", KTX], ["png", PNG], ["pnm", PNM], ["psd", PSD], ["svg", SVG], ["tga", TGA], ["tiff", TIFF], ["webp", WEBP]]);
const types = Array.from(typeHandlers.keys());

const firstBytes = /* @__PURE__ */new Map([[56, "psd"], [66, "bmp"], [68, "dds"], [71, "gif"], [73, "tiff"], [77, "tiff"], [82, "webp"], [105, "icns"], [137, "png"], [255, "jpg"]]);
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    ...
    // @ts-expect-error
    '../chunks/astro/assets-service_DT0UcKdX.mjs').then(n => n.Z).catch(e => {
...
async function getImage$1(options, imageConfig) {
  ...
  resolvedOptions.src.clone ?? resolvedOptions.src : resolvedOptions.src;
...
}, "/Users/matt/src/astro/packages/astro/components/Image.astro", void 0);
...
}, "/Users/matt/src/astro/packages/astro/components/Picture.astro", void 0);
...
const GET = async ({
  ...
  try {
    ...
    const {
      data,
      format
    } = await imageService.transform(new Uint8Array(inputBuffer), transform, imageConfig);
